...
public:
    ...
    void getTreeInfo(cJSON* ptmObj, cJSON* multiresObj, const QString &multiresStrategyId);
...
public:
    ...
    void saveDescriptorXML(const QString& destFolder, const QString& format);
    void saveDescriptorJSON(const QString& destFolder, const QString& format, const QString &geometryId, const QString &multiresStrategyId);
