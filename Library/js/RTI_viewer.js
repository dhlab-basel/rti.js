...
RTIViewer.prototype = {
  _init: function(ptmReference, container) {
    ...
    this._internalController = new RTIViewerInternalController(this);
    this._rendering = false;
  },
...
*/
function RTIViewerInternalController(viewer) {
  this._viewer = null;
  this._mouseMode = 0;
  ...
  this._init(viewer);
  return this;
} // RTIViewerInternalController

RTIViewerInternalController.prototype = {
